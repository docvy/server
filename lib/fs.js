...
* absolute
* @param options -- {Object} options, include: ignoreDotFiles
* @param callback -- {Function} callback(err, files)
*/
exports.readdir = readdir;
function readdir(dirpath, options, callback) {
  if ((! callback) && lodash.isFunction(options)) {
    callback = options;
    options = { };
  }
...
/**
* Reads a file. This is more of a convenience wrapper.
*
