...
/**
* Installing new plugins from NPM
*
* @param <pluginName> -- {String} name pf plugin
* @param [callback] -- {Function} callback(err)
*/
exports.installPlugin = installer.npmInstall;
...
* @param [callback] -- {Function} callback(err)
*/
exports.uninstallPlugin = installer.uninstall;
...
*/
exports.getPluginsInformation = installer.listPlugins;
...
function Plugin(name, module) {
  ...
  try {
    var _path = path.resolve(pluginsDirectory, name, "package.json");
